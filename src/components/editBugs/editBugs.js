      ...
      <div>
        ...
        <ul className="detail-list">
          <li className="current-item" key={currentBug.id}>
            ...
            <p className="detail">{`Bug Posted By: ${currentBug.bugPostedBy}`}</p>
            <p className="detail">{`Bug Description: ${currentBug.description}`}</p>
            <p className="detail">{`Bug Severity: ${currentBug.severity}`}</p>
            <p className="detail">{`Bug Status: ${currentBug.status}`}</p>
            <p className="detail">{`Bug Completed Notes: ${currentBug.completedNotes}`}</p>
          </li>
        </ul>
      </div>
    );
